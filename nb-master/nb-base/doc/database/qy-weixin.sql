...
DROP INDEX sys_user_office_id ON qy_user;
DROP INDEX sys_user_login_name ON qy_user;
DROP INDEX sys_user_company_id ON qy_user;
DROP INDEX sys_user_update_date ON qy_user;
DROP INDEX sys_user_del_flag ON qy_user;
...
CREATE INDEX sys_user_office_id ON qy_user ();
CREATE INDEX sys_user_login_name ON qy_user ();
CREATE INDEX sys_user_company_id ON qy_user ();
CREATE INDEX sys_user_update_date ON qy_user ();
CREATE INDEX sys_user_del_flag ON qy_user ();
