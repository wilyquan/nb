package com.nb.fastweixin.company.message.resp;

import com.nb.fastweixin.company.message.QYArticle;
import com.nb.fastweixin.message.Article;
import com.nb.fastweixin.message.RespType;
import com.nb.fastweixin.message.util.MessageBuilder;
