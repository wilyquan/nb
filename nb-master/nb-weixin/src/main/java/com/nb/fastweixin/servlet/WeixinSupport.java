...
import com.nb.fastweixin.handle.MessageHandle;
import com.nb.fastweixin.message.BaseMsg;
import com.nb.fastweixin.message.TextMsg;
import com.nb.fastweixin.message.aes.AesException;
import com.nb.fastweixin.message.aes.WXBizMsgCrypt;
import com.nb.fastweixin.message.req.*;
import com.nb.fastweixin.util.MessageUtil;
import com.nb.fastweixin.util.SignUtil;
...
import static com.nb.fastweixin.util.BeanUtil.isNull;
import static com.nb.fastweixin.util.BeanUtil.nonNull;
import static com.nb.fastweixin.util.CollectionUtil.isEmpty;
import static com.nb.fastweixin.util.CollectionUtil.isNotEmpty;
import static com.nb.fastweixin.util.StrUtil.isNotBlank;
